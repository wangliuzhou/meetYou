...
function CreatArry(s, e) {
  for (var a = [["无要求"], ["无要求"]], i = s; i <= e; i++)
    i < e && a[0].push(i), i > s && a[1].push(i);
  return a;
}
